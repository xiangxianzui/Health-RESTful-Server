...
public class UserFacadeREST extends AbstractFacade<User> {
    ...
    public void addUser(@PathParam("name") String name, @PathParam("age") int age, @PathParam("height") double height, @PathParam("weight") double weight, @PathParam("gender") int gender, @PathParam("activityLevel") int activityLevel, @PathParam("stepPerMile") double stepPerMile){
